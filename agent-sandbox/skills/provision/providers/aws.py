"""
AWS provider for agent-sandbox (boto3 backend).
...
purge_org_fixtures is the destructive counterpart called only by revoke.
"""
...
def surface_list() -> list[dict]:
    """Per-account read surfaces for cred-sweep. Each entry has a
