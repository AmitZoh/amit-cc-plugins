"""
AWS provider for sandbox-cred-sweep.
...
Skill 1 is the sibling agent-sandbox-provision skill under this same plugin's
skills/ directory.
...
# path: parent -> providers, parent.parent -> sandbox-cred-sweep, parent.parent.parent
...
log = common.get_logger("sandbox-cred-sweep.aws")
